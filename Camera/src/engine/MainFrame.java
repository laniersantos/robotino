...
/**
 * This is the main frame of this example. It provides an user interface to
 * enter the IP and connect to the robot, a basic interface to drive Robotino,
 * it shows the camera image and displays the standard text output.
 */
