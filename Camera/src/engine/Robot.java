...
/**
 * The class Robot demonstrates the usage of the most common robot component
 * classes. Furthermore it shows how to handle events and receive incoming
 * camera images.
 */
public class Robot {
	...
	public void addScaledVector(float[] srcDest, float[] uv, float scale) {
	...
	/**
	 * The class MyCom derives from rec.robotino.com.Com and implements some of
	...
	/**
	 * Class MyCamera inherits from rec.robotino.com.Camera and implements some
	 * of the virtual event handling methods. This is the standard approach for
	 * handling these Events.
	 */
